...
class Ciencias extends StatefulWidget {
  ...
  @override
  _CienciasState createState() => _CienciasState();
}

class _CienciasState extends State<Ciencias> {
  bool _showFirst = true;
  var randomciencia = Random().nextInt(10);

  void randomizermath() {
    setState(() {
      var randomciencia2 = Random().nextInt(10);
      if (randomciencia2 != randomciencia) {
        randomciencia = randomciencia2;
            ...
            AnimatedSwitcherPlus.flipY(
              ...
              child: _showFirst
                  ? Container(
                      ...
                      child: Center(
                        child: Padding(
                          ...
                          child: Text(
                            perguntasCiencias[randomciencia],
                  ...
                  : Container(
                      ...
                      child: Center(
                        child: Text(
                          respostasCiencias[randomciencia],
                          textAlign: TextAlign.center,
                          style: GoogleFonts.montserrat(
                            fontSize: 36,
                            fontWeight: FontWeight.bold,
