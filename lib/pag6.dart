...
class _PortuguesState extends State<Portugues> {
  ...
  var randomport = Random().nextInt(10);

  void randomizermath() {
    setState(() {
      var randomport2 = Random().nextInt(10);
      if (randomport2 != randomport) {
        randomport = randomport2;
