...
class _InglesState extends State<Ingles> {
  ...
  var randoming = Random().nextInt(10);

  void randomizermath() {
    setState(() {
      var randoming2 = Random().nextInt(10);
      if (randoming2 != randoming) {
        randoming = randoming2;
